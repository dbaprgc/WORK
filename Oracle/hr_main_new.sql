...
/* @%ORACLE_HOME%/demo/schema/human_resources/hr_main_new

CREATE PLUGGABLE DATABASE hr_pdb 
ADMIN USER hr_pdb_admin IDENTIFIED BY password
ROLES = (dba)
DEFAULT TABLESPACE my_tbs 
DATAFILE 'C:\app\oracle\oradata\ORCL\hr_pdb\mytbs01.dbf' SIZE 50M 
AUTOEXTEND ON
FILE_NAME_CONVERT=('C:\app\oracle\oradata\ORCL\pdbseed\','C:\app\oracle\oradata\ORCL\hr_pdb\');
